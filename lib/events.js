...
function __generateDetailPropForMouseEvent(type) {
  switch (type) {
    case 'click':
    case 'dblclick':
      return ++__currentClickCount;
    case 'mousedown':
    case 'mouseup':
      return __currentClickCount + 1;
    default:
      return 0;
  }
}
...
export function createMouseEvent(options) {
  ...
  const defaultOpts = {
    ...
    detail: __generateDetailPropForMouseEvent(options.type)
  };
