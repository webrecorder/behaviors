 ...
 * position is reached
 * @return {{scrollCountUp: number, scrollDown: (function(): void), scrollCountLeft: number, scrollLeft: Function, canScrollMoreUpDown: (function(): boolean), scrollCountDown: number, scrollCountRight: number, scrollUp: (function(): void), scrollRight: (function(): void)} & {timesToScroll: number, scrollUpDownAmount: number, scrollLeftRightAmount: number}}
 */
export function createScroller(timesToScroll) {
  const scrollAmount = createScrollAmount(timesToScroll || 10);
  return Object.assign(
    {
      canScrollMoreUpDown: canScrollMore,
      scrollCountDown: 0,
      scrollCountUp: 0,
      scrollCountLeft: 0,
      scrollCountRight: 0,
