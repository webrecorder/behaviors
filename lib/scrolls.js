...
/**
 * @desc Determines if we can scroll up any more
 ...
 * position is reached
 * @return {{scrollDown: (function(): void), scrollLeft: Function, canScrollDownMore: (function(): boolean), canScrollUpMore: (function(): boolean), scrollUp: (function(): void), scrollRight: (function(): void), timesToScroll: number, scrollUpDownAmount: number, scrollLeftRightAmount: number}}
 */
