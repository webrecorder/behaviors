 ...
 * @return {boolean}  - T/F to indicate that click happened.
 */
export function clickSelectedElementsNextElementSibling(selector, cntx) {
 ...
 * @return {boolean}  - T/F to indicate that click happened.
 */
export function clickSelectedElementsPreviousElementSibling(selector, cntx) {
  return click(selectedPreviousElementSibling(selector, cntx));
}
