 ...
 * @param {string} selector - the selector to be use
 * @param {Element} [context] - element to use rather than document for the querySelector call
...
/**
 * @desc Tests to see if the supplied element has the supplied css classes
...
/**
 * @desc Tests to see if the supplied element has any of the supplied css classes
...
/**
 * @desc Returns the next element sibling of the parent element of the
 * supplied element
 * @param {SomeElement} elem - The element to receive its sibling
 * @return {?SomeElement} - The elements sibling if it exists
 */
 ...
 * @param {string} selector - the selector to be use
 * @param {Element|Node|HTMLElement|Document} [cntx] - element to use rather than document for the querySelector call
 * @return {?string}
 */
 ...
 * @return {?string}
 */
export function elemDataValue(elem, dataValue) {
  if (!elem) return null;
  if (!elem.dataset) return null;
  return elem.dataset[dataValue];
}

/**
 * Returns T/F indicating if the supplied element
 * has children
 * @param {Element?} elem
 * @return {boolean}
 */
 ...
 * @return {IterableIterator<Element?>}
 */
