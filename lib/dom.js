...
/**
 * Returns the scroll top and left position of the supplied document,
 * defaults to current document
 * @param {?Document} doc
 * @return {{scrollTop: number, scrollLeft: number}}
 */
export function documentScrollPosition(doc) {
  const docRef = doc != null ? doc : document;
  const elem = docRef.body ? docRef.body : docRef.documentElement;
  return {
